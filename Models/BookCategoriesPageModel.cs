...
namespace Catinas_Darius_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Catinas_Darius_Lab2Context context,Book book)
        {
        ...
        public void UpdateBookCategories(Catinas_Darius_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
